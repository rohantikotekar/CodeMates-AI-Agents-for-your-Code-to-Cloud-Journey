...
def main():
    ...
    print("\n GitHub Actions Agent: Creating CI/CD Pipeline...")
    ...
    with open("pipeline.yml", "w", encoding="utf-8") as f:
        f.write(pipeline)
    print(" CI/CD Pipeline created!")

    # 2. Create Dockerfile
    print("\n Dockerfile Agent: Creating Dockerfile...")
    ...
    print("\n3️ Build Status Agent: Building and checking Docker image...")
    ...
    print("\n4️ Build Predictor Agent: Analyzing build patterns...")
